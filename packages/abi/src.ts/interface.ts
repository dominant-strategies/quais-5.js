...
import { arrayify, BytesLike, concat, hexDataSlice, hexlify, hexZeroPad, isHexString } from "@quais/bytes";
import { id } from "@quais/hash";
import { keccak256 } from "@quais/keccak256"
import { defineReadOnly, Description, getStatic } from "@quais/properties";
