...
function hexConcat(values) {
    return quais_1.quais.utils.hexlify(quais_1.quais.utils.concat(values.map(function (v) {
        if (v instanceof opcodes_1.Opcode) {
            return [v.value];
        }
        if (typeof (v) === "number") {
            if (v >= 0 && v <= 255 && !(v % 1)) {
                return quais_1.quais.utils.hexlify(v);
            }
            else {
...
var Script = /** @class */ (function () {
    function Script(filename, callback) {
        quais_1.quais.utils.defineReadOnly(this, "filename", filename);
        quais_1.quais.utils.defineReadOnly(this, "contextObject", this._baseContext(callback));
        quais_1.quais.utils.defineReadOnly(this, "context", vm_1.default.createContext(this.contextObject));
    }
    Script.prototype._baseContext = function (callback) {
        ...
        return new Proxy({
            ...
            quais: quais_1.quais,
            utils: quais_1.quais.utils,
            BigNumber: quais_1.quais.BigNumber,
            arrayify: quais_1.quais.utils.arrayify,
            concat: hexConcat,
            hexlify: quais_1.quais.utils.hexlify,
            zeroPad: function (value, length) {
                return quais_1.quais.utils.hexlify(quais_1.quais.utils.zeroPad(value, length));
            },
            id: quais_1.quais.utils.id,
            keccak256: quais_1.quais.utils.keccak256,
            namehash: quais_1.quais.utils.namehash,
            sha256: quais_1.quais.utils.sha256,
            parseEther: quais_1.quais.utils.parseEther,
            formatEther: quais_1.quais.utils.formatEther,
            parseUnits: quais_1.quais.utils.parseUnits,
            formatUnits: quais_1.quais.utils.formatUnits,
            randomBytes: function (length) {
                return quais_1.quais.utils.hexlify(quais_1.quais.utils.randomBytes(length));
            },
            toUtf8Bytes: quais_1.quais.utils.toUtf8Bytes,
            toUtf8String: quais_1.quais.utils.toUtf8String,
            formatBytes32String: quais_1.quais.utils.formatBytes32String,
            parseBytes32String: quais_1.quais.utils.parseBytes32String,
            Opcode: opcodes_1.Opcode,
            sighash: function (signature) {
                return quais_1.quais.utils.id(quais_1.quais.utils.FunctionFragment.from(signature).format()).substring(0, 10);
            },
            topichash: function (signature) {
                return quais_1.quais.utils.id(quais_1.quais.utils.EventFragment.from(signature).format());
            },
            assemble: assemble,
...
var ValueNode = /** @class */ (function (_super) {
    ...
    ValueNode.prototype.getPushLiteral = function (value) {
        ...
        var hex = quais_1.quais.utils.hexlify(value);
        if (hex === "0x") {
            ...
            return __generator(this, function (_a) {
                ...
                if (this.verbatim) {
                    if (this.value.substring(0, 2) === "0x") {
                        ...
                        visit(this, quais_1.quais.BigNumber.from(this.value).toHexString());
                    }
                }
                else {
                    visit(this, this.getPushLiteral(quais_1.quais.BigNumber.from(this.value)));
                }
                assembler.end(this);
                return [2 /*return*/];
            });
                ...
                if (isOffset && assembler.positionIndependentCode) {
                    ...
                    if (here > value) {
                        ...
                        for (w = 1; w <= 5; w++) {
                            ...
                            if (quais_1.quais.utils.hexDataLength(literal) <= w) {
                                literal = quais_1.quais.utils.hexZeroPad(literal, w);
                                break;
                            }
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        // Append this opcode
                        visit(this, quais_1.quais.utils.hexlify(this.opcode.value));
                        assembler.end(this);
                        return [2 /*return*/];
                }
            });
...
var LabelNode = /** @class */ (function (_super) {
    ...
    LabelNode.prototype.assemble = function (assembler, visit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                assembler.start(this);
                visit(this, quais_1.quais.utils.hexlify(opcodes_1.Opcode.from("JUMPDEST").value));
                assembler.end(this);
                return [2 /*return*/];
            });
        });
    ...
    PaddingNode.prototype.assemble = function (assembler, visit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                padding.fill(0);
                visit(this, quais_1.quais.utils.hexlify(padding));
                assembler.end(this);
                return [2 /*return*/];
            });
        });
...
var DataNode = /** @class */ (function (_super) {
    ...
    function DataNode(guard, location, name, data) {
        ...
        quais_1.quais.utils.defineReadOnly(_this, "padding", new PaddingNode(Guard, _this.location));
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        bytecode = quais_1.quais.utils.concat(this.data.map(function (d) { return assembler.getBytecode(d); }));
                        i = 0;
                    ...
                    case 1:
                        ...
                        if (this.verbatim) {
                            if (typeof (result) === "number") {
                                visit(this, quais_1.quais.BigNumber.from(result).toHexString());
                            }
                            else {
                                visit(this, quais_1.quais.utils.hexlify(result));
                            }
                        }
                        else {
...
function disassemble(bytecode) {
    var ops = [];
    var offsets = {};
    var bytes = quais_1.quais.utils.arrayify(bytecode, { allowMissingPrefix: true });
    var i = 0;
    var oob = false;
    while (i < bytes.length) {
        ...
        if (push) {
            var data = quais_1.quais.utils.hexlify(bytes.slice(i, i + push));
            if (quais_1.quais.utils.hexDataLength(data) === push) {
                op.pushValue = data;
                op.length += push;
                i += push;
            }
    ...
    ops.getBytes = function (offset, length) {
        ...
        return quais_1.quais.utils.arrayify(result);
    };
...
function formatBytecode(bytecode) {
    ...
    bytecode.forEach(function (op) {
        ...
        var offset = quais_1.quais.utils.hexZeroPad(quais_1.quais.utils.hexlify(op.offset), 2);
...
var Assembler = /** @class */ (function () {
    function Assembler(root, positionIndependentCode) {
        quais_1.quais.utils.defineReadOnly(this, "root", root);
        quais_1.quais.utils.defineReadOnly(this, "positionIndependentCode", !!positionIndependentCode);
        var nodes = {};
        var labels = {};
        var parents = {};
        ...
        root.visit(function (node) {
            ...
            if (node instanceof LabelledNode) {
                ...
                if (labels[node.name]) {
                    logger.throwError(("duplicate label: " + node.name), quais_1.quais.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
        ...
        root.visit(function (node) {
            ...
            if (node instanceof LinkNode) {
                ...
                if (!target) {
                    logger.throwError(("missing label: " + node.label), quais_1.quais.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
            }
        ...
        quais_1.quais.utils.defineReadOnly(this, "labels", Object.freeze(labels));
        quais_1.quais.utils.defineReadOnly(this, "nodes", Object.freeze(nodes));
        quais_1.quais.utils.defineReadOnly(this, "_parents", Object.freeze(parents));
    }
    // Link operations
    ...
    Assembler.prototype.getLinkValue = function (target, source) {
        ...
        var bytes = Array.prototype.slice.call(quais_1.quais.utils.arrayify(info.bytecode));
        quais_1.quais.utils.defineReadOnly(bytes, "ast", target);
        quais_1.quais.utils.defineReadOnly(bytes, "source", target.location.source);
        ...
        if (safeOffset) {
            ...
            quais_1.quais.utils.defineReadOnly(bytes, "_freeze", function () {
                ...
                frozen_1 = true;
                quais_1.quais.utils.defineReadOnly(bytes, "offset", bytes.offset);
            });
        }
        return bytes;
    };
...
var CodeGenerationAssembler = /** @class */ (function (_super) {
    ...
    function CodeGenerationAssembler(root, options) {
        ...
        quais_1.quais.utils.defineReadOnly(_this, "retry", ((options.retry != null) ? options.retry : 512));
        quais_1.quais.utils.defineReadOnly(_this, "filename", (0, path_1.resolve)(options.filename || "./contract.asm"));
        quais_1.quais.utils.defineReadOnly(_this, "defines", Object.freeze(options.defines || {}));
        quais_1.quais.utils.defineReadOnly(_this, "_stack", []);
        _this.reset();
        return _this;
    }
        ...
        try {
            if (result.offset < 0) {
                ...
                this._checks.push(function () {
                    ...
                    if (check.offset === result.offset && quais_1.quais.utils.hexlify(check) === quais_1.quais.utils.hexlify(result)) {
                        return true;
                    }
                    return false;
                });
            ...
            this._checks.push(function () {
                var check = _super.prototype.getLinkValue.call(_this, target, source);
                return (quais_1.quais.utils.hexlify(check) === quais_1.quais.utils.hexlify(result));
            });
        }
        return result;
    };
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.root.assemble(this, function (node, bytecode) {
                                ...
                                offset += quais_1.quais.utils.hexDataLength(bytecode);
                            })];
                    case 1:
                        _a.sent();
                        this._runChecks();
...
function parse(code, options) {
    ...
    _parser_1.parser.yy._quaisLocation = function (loc) {
    ...
    _parser_1.parser.yy._quaisLocation = null;
    // Semantic Checks
