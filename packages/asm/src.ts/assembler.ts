...
function hexConcat(values: Array<Opcode | quais.utils.BytesLike>): string {
...
class Script {
    ...
    _baseContext(callback: (name: string, context: any) => any): any {
         return new Proxy({
            ...
            zeroPad: function(value: quais.utils.BytesLike, length: number) {
...
export abstract class Node {
    ...
    constructor(guard: any, location: Location, options: { [ key: string ]: any }) {
        ...
        for (const key in options) {
            quais.utils.defineReadOnly<any, any>(this, key, options[key]);
        }
    }
...
export abstract class ValueNode extends Node {
    ...
    getPushLiteral(value: quais.utils.BytesLike | quais.utils.Hexable | number) {
            ...
            if (node instanceof LabelledNode) {
                ...
                if (labels[node.name]) {
                    logger.throwError(
                        ...
                        quais.utils.Logger.errors.UNSUPPORTED_OPERATION,
                        { }
                    );
                }
...
export function parse(code: string, options?: ParserOptions): Node {
    ...
    _parser.yy._quaisLocation = function(loc?: _Location): Location {
