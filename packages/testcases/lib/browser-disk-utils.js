...
function loadTests(tag) {
    ...
    if (Cache[filename] == null) {
        ...
        try {
            ...
            var size = parseInt(comps[0]), compressedData = quais_1.quais.utils.base64.decode(comps[1]);
            var uncompressedData = new Uint8Array(size);
            (0, tiny_inflate_1.default)(compressedData, uncompressedData);
            Cache[filename] = JSON.parse(quais_1.quais.utils.toUtf8String(uncompressedData));
        }
        catch (error) {
