...
class EnsPlugin extends Plugin {
    ...
    getEthRegistrar() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let address = yield this.getEns().owner(quais.utils.namehash("eth"));
...
class AccountPlugin extends EnsPlugin {
    ...
    _setValue(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            quais.utils.defineReadOnly(this, key, value);
            if (key === "name") {
                yield this._setValue("nodehash", quais.utils.namehash(value));
            }
        });
    }
    prepareArgs(args) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield _super.prepareArgs.call(this, args);
            let helpLine = quais.utils.getStatic(this.constructor, "getHelp")().name;
...
class SetSubnodePlugin extends AddressAccountPlugin {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.getEns().setSubnodeOwner(quais.utils.namehash(this.node), quais.utils.id(this.label), this.address);
        });
    }
}
    ...
    _setValue(key, value) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (key === "hash") {
                ...
                yield _super._setValue.call(this, "multihash", quais.utils.hexlify(multihash));
            }
            yield _super._setValue.call(this, key, value);
        });
    }
...
class MigrateRegistrarPlugin extends AccountPlugin {
    ...
    prepareArgs(args) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let entry = yield ethLegacyRegistrar.entries(quais.utils.id(comps[0]));
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let legacyRegistrar = yield this.getEthLegacyRegistrar();
            yield legacyRegistrar.transferRegistrars(quais.utils.id(this.label));
        });
    }
}
...
class TransferPlugin extends AccountPlugin {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let registrar = yield this.getEthRegistrar();
            yield registrar.safeTransferFrom(this.accounts[0].getAddress(), this.new_owner, quais.utils.id(this.label));
        });
    }
}
...
class ReclaimPlugin extends AddressAccountPlugin {
    ...
    _setValue(key, value) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (key === "name") {
                ...
                let ownerOf = null;
                try {
                    ownerOf = yield registrar.ownerOf(quais.utils.id(comps[0]));
                }
                catch (error) {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let registrar = yield this.getEthRegistrar();
            yield registrar.reclaim(quais.utils.id(this.label), this.address);
        });
    }
}
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < this.labels.length; i++) {
                ...
                console.log(label);
                const expiration = (yield ethRegistrar.nameExpires(quais.utils.id(label))).toNumber();
                if (expiration === 0) {
