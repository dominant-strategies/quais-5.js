...
and debug Ethereum-related tasks using the quais.js library.

**To install:**

```
/home/ricmoo> npm install -g @quais/cli
```
...
to running `node`, with many features from the quais.js library
...
```
/home/ricmoo> quais init ropsten.json
...
Saved:               ropsten.json
/home/ricmoo> quais --wait --network ropsten fund 0xe923a7f82860C30442a1A541C14bE4251bd71A34
...
```
/home/ricmoo> quais eval 'namehash("ricmoose.eth")'
0xb52c4744695ed3be701ccef35d5901de3aaf7294245966ef16617c30aab7b626

/home/ricmoo> quais eval 'id("Hello...")'
0x9cd41c139084dafa62261ce045f504e3c697fa303c87a78b241a9f8ae65bae88

/home/ricmoo> quais --network ropsten eval '(new Contract(provider.network.ensAddress, [ "function owner(bytes32) view returns (address)" ], provider)).owner(namehash("eth"))'
...
```
/home/ricmoo> quais --network ropsten --account mnemonic.txt
...
```
Usage:
   quais [ COMMAND ] [ ARGS ] [ OPTIONS ]

COMMANDS (default: sandbox)
   sandbox                    Run a REPL VM environment with quais
   ...
   eval CODE                  Run CODE in a VM with quais
   run FILENAME               Run FILENAME in a VM with quais
...
```
Usage:
   quais-ens COMMAND [ ARGS ] [ OPTIONS ]
