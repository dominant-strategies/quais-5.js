...
function setupContext(path, context, plugin) {
    ...
    context.quais = quais_1.quais;
    context.version = quais_1.quais.version;
    context.Contract = quais_1.quais.Contract;
    context.ContractFactory = quais_1.quais.ContractFactory;
    context.Wallet = quais_1.quais.Wallet;
    context.providers = quais_1.quais.providers;
    context.utils = quais_1.quais.utils;
    context.abiCoder = quais_1.quais.utils.defaultAbiCoder;
    context.BN = quais_1.quais.BigNumber;
    context.BigNumber = quais_1.quais.BigNumber;
    context.FixedNumber = quais_1.quais.FixedNumber;
    context.getAddress = quais_1.quais.utils.getAddress;
    context.getContractAddress = quais_1.quais.utils.getContractAddress;
    context.getIcapAddress = quais_1.quais.utils.getIcapAddress;
    context.arrayify = quais_1.quais.utils.arrayify;
    context.concat = quais_1.quais.utils.concat;
    context.hexlify = quais_1.quais.utils.hexlify;
    context.zeroPad = quais_1.quais.utils.zeroPad;
    context.joinSignature = quais_1.quais.utils.joinSignature;
    context.splitSignature = quais_1.quais.utils.splitSignature;
    context.id = quais_1.quais.utils.id;
    context.keccak256 = quais_1.quais.utils.keccak256;
    context.namehash = quais_1.quais.utils.namehash;
    context.sha256 = quais_1.quais.utils.sha256;
    context.parseEther = quais_1.quais.utils.parseEther;
    context.parseUnits = quais_1.quais.utils.parseUnits;
    context.formatEther = quais_1.quais.utils.formatEther;
    context.formatUnits = quais_1.quais.utils.formatUnits;
    context.randomBytes = quais_1.quais.utils.randomBytes;
    context.constants = quais_1.quais.constants;
    context.parseTransaction = quais_1.quais.utils.parseTransaction;
    context.serializeTransaction = quais_1.quais.utils.serializeTransaction;
    context.toUtf8Bytes = quais_1.quais.utils.toUtf8Bytes;
    context.toUtf8String = quais_1.quais.utils.toUtf8String;
}
...
var SandboxPlugin = /** @class */ (function (_super) {
    ...
    SandboxPlugin.getHelp = function () {
        return {
            name: "sandbox",
            help: "Run a REPL VM environment with quais"
        };
    };
...
var FundPlugin = /** @class */ (function (_super) {
    ...
    FundPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url;
            return __generator(this, function (_a) {
                url = "https:/" + "/api.quais.io/api/v1/?action=fundAccount&address=" + this.toAddress.toLowerCase();
                return [2 /*return*/, quais_1.quais.utils.fetchJson(url).then(function (data) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, quais_1.quais.utils.resolveProperties({
                    ...
                    case 2:
                        ...
                        info = {
                            "Address": address,
                            "Balance": (quais_1.quais.utils.formatEther(balance) + " ether"),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.data = quais_1.quais.utils.hexlify(argParser.consumeOption("data") || "0x");
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        this.value = quais_1.quais.utils.parseEther(args[1]);
                        return [2 /*return*/];
                }
            });
        });
...
var SweepPlugin = /** @class */ (function (_super) {
    ...
    SweepPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, quais_1.quais.utils.resolveProperties({
...
var EvalPlugin = /** @class */ (function (_super) {
    ...
    EvalPlugin.getHelp = function () {
        return {
            name: "eval CODE",
            help: "Run CODE in a VM with quais"
        };
    };
...
var RunPlugin = /** @class */ (function (_super) {
    ...
    RunPlugin.getHelp = function () {
        return {
            name: "run FILENAME",
            help: "Run FILENAME in a VM with quais"
        };
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.value = quais_1.quais.utils.parseEther(args[0]);
                        return [4 /*yield*/, this.accounts[0].getAddress()];
                    case 2:
                        address = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.dump("Wrapping ether", {
                            "From": address,
                            "Value": quais_1.quais.utils.formatEther(this.value)
                        });
                        contract = new quais_1.quais.Contract(WethAddress, WethAbi, this.accounts[0]);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        this.contract = new quais_1.quais.Contract(tokenAddress, Erc20Abi, this.accounts[0]);
                        _a = this;
                    ...
                    case 4:
                        _b.toAddress = _c.sent();
                        this.value = quais_1.quais.utils.parseUnits(args[2], this.decimals);
                        return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    case 0:
                        info = {
                            ...
                            "Value": quais_1.quais.utils.formatUnits(this.value, this.decimals)
                        };
                        namePromise = this.contract.name().then(function (name) {
                            ...
                            var contract = new quais_1.quais.Contract(_this.contract.address, Erc20AltAbi, _this.contract.signer);
                            contract.name().then(function (name) {
                                info["Token Name"] = quais_1.quais.utils.parseBytes32String(name);
                            }, function (error) {
                                throw error;
                            });
                        });
                        symbolPromise = this.contract.symbol().then(function (symbol) {
                            ...
                            contract.symbol().then(function (symbol) {
                                info["Token Symbol"] = quais_1.quais.utils.parseBytes32String(symbol);
                            }, function (error) {
                                throw error;
                            });
                        });
            ...
            return __generator(this, function (_a) {
                ...
                result.forEach(function (contract, index) {
                    output[contract.name] = {
                        ...
                        interface: contract.interface.fragments.map(function (f) { return f.format(quais_1.quais.utils.FormatTypes.full); }),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        factory = new quais_1.quais.ContractFactory(codes[0].interface, codes[0].bytecode, this.accounts[0]);
                        (0, cli_1.dump)("Deploying:", {
                            Contract: codes[0].name,
                            Bytecode: codes[0].bytecode,
                            Interface: codes[0].interface.fragments.map(function (f) { return f.format(quais_1.quais.utils.FormatTypes.full); }),
