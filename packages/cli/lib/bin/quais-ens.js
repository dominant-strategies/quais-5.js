...
var EnsPlugin = /** @class */ (function (_super) {
    ...
    function EnsPlugin() {
        ...
        quais_1.quais.utils.defineReadOnly(_this, "_ethAddressCache", {});
        return _this;
    }
    EnsPlugin.prototype.getEns = function () {
        return new quais_1.quais.Contract(this.network.ensAddress, ensAbi, this.accounts[0] || this.provider);
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _a[_b] = _c.sent();
                        _c.label = 2;
                    case 2: return [2 /*return*/, new quais_1.quais.Contract(this._ethAddressCache[nodehash], resolverAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
    EnsPlugin.prototype.getEthInterfaceAddress = function (interfaceId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ethNodehash = quais_1.quais.utils.namehash("eth");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        address = _a.sent();
                        return [2 /*return*/, new quais_1.quais.Contract(address, ethControllerAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        address = _a.sent();
                        return [2 /*return*/, new quais_1.quais.Contract(address, ethLegacyRegistrarAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
    EnsPlugin.prototype.getEthRegistrar = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getEns().owner(quais_1.quais.utils.namehash("eth"))];
                    case 1:
                        address = _a.sent();
                        return [2 /*return*/, new quais_1.quais.Contract(address, ethRegistrarAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        nodehash = quais_1.quais.utils.namehash(name_1);
                                        details = {
                                            Nodehash: nodehash
                                        };
                                    ...
                                    case 1:
                                        ...
                                        if (!(owner === quais_1.quais.constants.AddressZero)) return [3 /*break*/, 2];
                                        owner = null;
                                        return [3 /*break*/, 4];
                                    case 2:
                                        ...
                                        return [4 /*yield*/, ens.resolver(nodehash).then(function (address) {
                                                if (address === quais_1.quais.constants.AddressZero) {
                                    ...
                                    case 4:
                                        ...
                                        details.Labelhash = quais_1.quais.utils.id(comps[0].toLowerCase()); // @TODO: nameprep
                                        _c = details;
                                    ...
                                    case 7:
                                        ownerOf = _g.sent();
                                        if (ownerOf !== quais_1.quais.constants.AddressZero) {
                                    ...
                                    case 9:
                                        entry = _g.sent();
                                        deed = new quais_1.quais.Contract(entry.owner, deedAbi, this_1.provider);
                                        _d = details;
                                        return [4 /*yield*/, deed.owner()];
                                    case 10:
                                        _d.Registrant = _g.sent();
                                        details.Registrar = "Legacy";
                                        details["Deed Value"] = (quais_1.quais.utils.formatEther(entry.value) + " ether");
                                        details["Highest Bid"] = (quais_1.quais.utils.formatEther(entry.highestBid) + " ether");
                                        return [3 /*break*/, 11];
                                    case 11:
                                        if (!resolverAddress) return [3 /*break*/, 16];
                                        resolver = new quais_1.quais.Contract(resolverAddress, resolverAbi, this_1.provider);
                                        _e = details;
                                        _f = "Address";
                                    ...
                                    case 14:
                                        ...
                                        return [4 /*yield*/, resolver.contenthash(nodehash).then(function (hash) {
                                                ...
                                                if (hash.substring(0, 10) === "0xe3010170" && quais_1.quais.utils.isHexString(hash, 38)) {
                                                    return basex_1.Base58.encode(quais_1.quais.utils.hexDataSlice(hash, 4)) + " (IPFS)";
                                                }
...
var AccountPlugin = /** @class */ (function (_super) {
    ...
    AccountPlugin.getHelp = function () {
        return logger.throwError("subclasses must implement this", quais_1.quais.errors.UNSUPPORTED_OPERATION, {
            operation: "getHelp"
        });
    };
    AccountPlugin.prototype._setValue = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        quais_1.quais.utils.defineReadOnly(this, key, value);
                        if (!(key === "name")) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._setValue("nodehash", quais_1.quais.utils.namehash(value))];
                    case 1:
                        _a.sent();
                        _a.label = 2;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        helpLine = quais_1.quais.utils.getStatic(this.constructor, "getHelp")().name;
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (secret) {
                            ...
                            this.salt = quais_1.quais.utils.id(secret);
                        }
                    ...
                    case 5:
                        ...
                        quais_1.quais.utils.defineReadOnly(this, "duration", duration * (60 * 60 * 24));
                        return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        signature = _a.sent();
                        this.salt = quais_1.quais.utils.keccak256(signature);
                        _a.label = 3;
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        this.dump("Commit: " + this.name, {
                            ...
                            Fee: quais_1.quais.utils.formatEther(fee) + " (informational)",
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this.dump("Reveal: " + this.name, {
                            ...
                            Fee: quais_1.quais.utils.formatEther(fee),
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getEns().setSubnodeOwner(quais_1.quais.utils.namehash(this.node), quais_1.quais.utils.id(this.label), this.address)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        nodehash = quais_1.quais.utils.namehash(this.address.substring(2) + ".addr.reverse");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        multihash = quais_1.quais.utils.concat(["0xe3010170", bytes]);
                        return [4 /*yield*/, _super.prototype._setValue.call(this, "multihash", quais_1.quais.utils.hexlify(multihash))];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, _super.prototype._setValue.call(this, key, value)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, ethLegacyRegistrar.entries(quais_1.quais.utils.id(comps[0]))];
                    case 4:
                        entry = _a.sent();
                        ...
                        deed = new quais_1.quais.Contract(entry.owner, deedAbi, this.provider);
                        return [4 /*yield*/, deed.owner()];
                    case 5:
                        owner = _a.sent();
                        return [4 /*yield*/, this.accounts[0].getAddress()];
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.dump("Migrate Registrar: " + this.name, {
                            "Nodehash": this.nodehash,
                            "Highest Bid": (quais_1.quais.utils.formatEther(this.highestBid) + " ether"),
                            "Deed Value": (quais_1.quais.utils.formatEther(this.deedValue) + " ether"),
                        });
                        return [4 /*yield*/, this.getEthLegacyRegistrar()];
                    case 2:
                        legacyRegistrar = _a.sent();
                        return [4 /*yield*/, legacyRegistrar.transferRegistrars(quais_1.quais.utils.id(this.label))];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        registrar = _a.sent();
                        return [4 /*yield*/, registrar.safeTransferFrom(this.accounts[0].getAddress(), this.new_owner, quais_1.quais.utils.id(this.label))];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, registrar.ownerOf(quais_1.quais.utils.id(comps[0]))];
                    case 4:
                        ownerOf = _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        registrar = _a.sent();
                        return [4 /*yield*/, registrar.reclaim(quais_1.quais.utils.id(this.label), this.address)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        label = this.labels[i];
                        console.log(label);
                        return [4 /*yield*/, ethRegistrar.nameExpires(quais_1.quais.utils.id(label))];
                    case 5:
...
//# sourceMappingURL=quais-ens.js.map