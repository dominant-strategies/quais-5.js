...
describe('Test JSON Wallets', function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (test.hasAddress) {
                                assert_1.default.ok((quais_1.quais.utils.getJsonWalletAddress(test.json) !== null), 'detect encrypted JSON wallet');
                            }
                            return [4 /*yield*/, quais_1.quais.Wallet.fromEncryptedJson(test.json, test.password)];
                        case 1:
                            wallet = _a.sent();
                        ...
                        case 2:
                            ...
                            // Test connect
                            {
                                provider = new quais_1.quais.providers.EtherscanProvider();
                            ...
                            {
                                wallet2 = new quais_1.quais.Wallet(wallet._signingKey());
    ...
    ['one', 'two', 'three'].forEach(function (i) {
        ...
        var wallet = quais_1.quais.Wallet.createRandom({ path: "m/56'/82", extraEntropy: utils.randomHexString('test-' + i, 32) });
        it('encrypts and decrypts a random wallet - ' + i, function () {
            this.timeout(1200000);
            return wallet.encrypt(password).then(function (json) {
                return quais_1.quais.Wallet.fromEncryptedJson(json, password).then(function (decryptedWallet) {
    ...
    function checkTransaction(parsedTransaction, test) {
        ...
        ['nonce', 'gasLimit', 'gasPrice', 'to', 'value', 'data'].forEach(function (key) {
            ...
            if (["gasLimit", "gasPrice", "value"].indexOf(key) >= 0) {
                ...
                value = quais_1.quais.utils.hexlify(value);
                if (!expected || expected === '0x') {
                    expected = '0x00';
                }
            }
                ...
                if (value) {
                    ...
                    quais_1.quais.utils.getAddress(value);
...
describe('Test Signing Messages', function () {
    var tests = [
        ...
        // See: https://github.com/quais-io/quais.js/issues/80
        {
            ...
            message: quais_1.quais.utils.arrayify('0x47173285a8d7341e5e972fc677286384f802f8ef42a5ec5f03bbfa254cb01fad'),
        ...
        // See: https://github.com/quais-io/quais.js/issues/85
        {
            ...
            message: quais_1.quais.utils.arrayify(quais_1.quais.utils.id('0x7f23b5eed5bc7e89f267f339561b2697faab234a2')),
    ...
    tests.forEach(function (test) {
        it(('verifies a message "' + test.name + '"'), function () {
            this.timeout(120000);
            var address = quais_1.quais.utils.verifyMessage(test.message, test.signature);
    ...
    tests.forEach(function (test) {
        it(('hashes a message "' + test.name + '"'), function () {
            this.timeout(120000);
            var hash = quais_1.quais.utils.hashMessage(test.message);
...
describe("Wallet Errors", function () {
    it("fails on privateKey/address mismatch", function () {
        assert_1.default.throws(function () {
            var wallet = new quais_1.quais.Wallet({
    ...
    it("fails on from mismatch", function () {
        var _this = this;
        var wallet = new quais_1.quais.Wallet("0x6a73cd9b03647e83ef937888a5258a26e4c766dbf41ddd974f15e32d09cfe9c0");
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        if (error_1.code === quais_1.quais.utils.Logger.errors.INVALID_ARGUMENT && error_1.argument === "transaction.from") {
                            resolve(true);
                            return [2 /*return*/];
                        }
                        return [3 /*break*/, 3];
